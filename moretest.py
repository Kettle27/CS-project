...
class App(Frame):
    ...
    def launch_main(self):
        ...
        Button(self.subframe1, text="1", width= 5, command= lambda: self.plot_entry.insert(END, "1")).place(x=15, y = 110)
        Button(self.subframe1, text="2", width= 5, command= lambda: self.plot_entry.insert(END, "2")).place(x=60, y = 110)
        Button(self.subframe1, text="3", width= 5, command= lambda: self.plot_entry.insert(END, "3")).place(x=105, y = 110)

        Button(self.subframe1, text="4", width= 5, command= lambda: self.plot_entry.insert(END, "4")).place(x=15, y = 135)
        Button(self.subframe1, text="5", width= 5, command= lambda: self.plot_entry.insert(END, "5")).place(x=60, y = 135)
        Button(self.subframe1, text="6", width= 5, command= lambda: self.plot_entry.insert(END, "6")).place(x=105, y = 135)

        Button(self.subframe1, text="7", width= 5, command= lambda: self.plot_entry.insert(END, "7")).place(x=15, y = 160)
        Button(self.subframe1, text="8", width= 5, command= lambda: self.plot_entry.insert(END, "8")).place(x=60, y = 160)
        Button(self.subframe1, text="9", width= 5, command= lambda: self.plot_entry.insert(END, "9")).place(x=105, y = 160)

        Button(self.subframe1, text="Delete", width= 5, command= lambda: self.plot_entry.delete(self.plot_entry.index("end")-1)).place(x=15, y = 185)
        Button(self.subframe1, text="0", width= 5, command= lambda: self.plot_entry.insert(END, "0")).place(x=60, y = 185)
        Button(self.subframe1, text="Clear", width= 5, command= lambda: self.plot_entry.delete(0, END)).place(x=105, y = 185)


        Button(self.subframe1, text="π", width= 5, command= lambda: self.plot_entry.insert(END, "π")).place(x=150, y = 110)
        Button(self.subframe1, text="e", width= 5, command= lambda: self.plot_entry.insert(END, "e")).place(x=195, y = 110)
        Button(self.subframe1, text="log", width= 5, command= lambda: self.plot_entry.insert(END, "log10")).place(x=240, y = 110)

        Button(self.subframe1, text="sin", width= 5, command= lambda: self.plot_entry.insert(END, "sin")).place(x=150, y = 135)
        Button(self.subframe1, text="cos", width= 5, command= lambda: self.plot_entry.insert(END, "cos")).place(x=195, y = 135)
        Button(self.subframe1, text="tan", width= 5, command= lambda: self.plot_entry.insert(END, "tan")).place(x=240, y = 135)
    ...
    def plot_graph(self, fx):
        ...
        try:
            ...
            self.plotlist.append([f"plot{self.mylist.size()+1}", fx , graph])
    ...
    def edit_graph(self):
        ...
        if is_selected:
            ...
            #self.plot_entry.insert(END, self.mylist.get(is_selected[0]))
